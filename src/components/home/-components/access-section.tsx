        ...
        <For each={accessCards}>
          {(card, index) => (
            <article
              ...
              class="relative flex min-h-0 animate-rise-in flex-col rounded-[0.875rem] border border-mm-line bg-white p-4.5 [transition:transform_350ms_ease-in-out,border-color_450ms_ease-out,box-shadow_450ms_ease-out] focus-within:-translate-y-1.5 focus-within:border-[rgb(30_58_95/30%)] focus-within:shadow-[0_1.25rem_2.25rem_-1.75rem_rgb(20_48_79/50%)] hover:-translate-y-1.5 hover:border-[rgb(30_58_95/30%)] hover:shadow-[0_1.25rem_2.25rem_-1.75rem_rgb(20_48_79/50%)] motion-reduce:animate-none md:gap-3 md:p-5.5 lg:min-h-74 lg:rounded-[1.25rem] lg:p-8"
            >
